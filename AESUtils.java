...
public class AESUtils {
    ...
    public static String encryptAES(String content, String password) {
        try {
            ...
            logger.error("加密出错,内容={}，密码={},异常={}", content, password, LogExceptionStackTrace.erroStackTrace(e));
        }
        return "-1";
    }
    ...
    public static byte[] decrypt(byte[] content, String password) {
        try {
            ...
            logger.error("解密出错,内容={}，密码={},异常={}", content, password, LogExceptionStackTrace.erroStackTrace(e));
        }
        return "-1".getBytes();
    }
